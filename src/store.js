...
export const store = createStore({
    ...
    actions: {
        ...
        initialize({ state }) {
            ...
            state.data['venus'] =         { id:'venus',         unlocked:false, count:0, max:1, costType:'FIXED', baseCosts:[{ id:'fuel', count:100 }], notifs:['innerSolarSystemPane'], unlocks:['methane', 'achMethane', 'methaneT1', 'achMethaneT1', 'energyT3', 'achEnergyT3'], }
            state.data['mars'] =          { id:'mars',          unlocked:false, count:0, max:1, costType:'FIXED', baseCosts:[{ id:'fuel', count:75  }], notifs:['innerSolarSystemPane'], unlocks:['titanium', 'achTitanium', 'titaniumT1', 'achTitaniumT1', 'silicon', 'achSilicon', 'siliconT1', 'achSiliconT1'], }
            ...
            state.data['star123501']	=	{	id:'star123501',	unlocked:false,	status:'new',	donor:false,	count:0,	spy:0,	distance:30.95,	planets:1,	faction:'prasnian',	resource1:'carbon',	resource2:'carbon',	stats:{	'power':2844,	'defense':1816,	'speed':12	},	costType:'FIXED',	baseCosts:[{	id:'antimatter',	count:309500	}],	notifs:['interstellarPrasnianPane'],	atmosphere:true,	subStatus:'none',	probeBaseCosts:[{	id:'probe',	count:1	},	{	id:'antimatter',	count:309500	}],	terraformBaseCosts:[{	id:'terraformer',	count:1	},	{	id:'antimatter',	count:309500	}],	statueBaseCosts:[{	id:'carbon',	count:100000000000000	},	{	id:'carbon',	count:100000000000000	}],	}
            ...
            state.data['star99701']	    =	{	id:'star99701',	unlocked:false,	status:'new',	donor:false,	count:0,	spy:0,	distance:34.33,	planets:4,	faction:'kitrinos',	resource1:'ice',	resource2:'ice',	stats:{	'power':3812,	'defense':2495,	'speed':10	},	costType:'FIXED',	baseCosts:[{	id:'antimatter',	count:343300	}],	notifs:['interstellarKitrinosPane'],	atmosphere:false,	subStatus:'none',	probeBaseCosts:[{	id:'probe',	count:1	},	{	id:'antimatter',	count:343300	}],	terraformBaseCosts:[{	id:'terraformer',	count:1	},	{	id:'antimatter',	count:343300	}],	statueBaseCosts:[{	id:'ice',	count:100000000000000	},	{	id:'ice',	count:100000000000000	}],	}
            ...
            state.data['star13601']	=	{	id:'star13601',	unlocked:false,	status:'new',	donor:false,	count:0,	spy:0,	distance:11.9,	planets:4,	faction:'moviton',	resource1:'silicon',	resource2:'silicon',	stats:{	'power':491,	'defense':413,	'speed':6	},	costType:'FIXED',	baseCosts:[{	id:'antimatter',	count:119000	}],	notifs:['interstellarMovitonPane'],	atmosphere:true,	subStatus:'none',	probeBaseCosts:[{	id:'probe',	count:1	},	{	id:'antimatter',	count:119000	}],	terraformBaseCosts:[{	id:'terraformer',	count:1	},	{	id:'antimatter',	count:119000	}],	statueBaseCosts:[{	id:'silicon',	count:100000000000000	},	{	id:'silicon',	count:100000000000000	}],	}
            ...
            state.data['star185101']	=	{	id:'star185101',	unlocked:false,	status:'new',	donor:true,	count:0,	spy:0,	distance:17.05,	planets:1,	faction:'moviton',	resource1:'gold',	resource2:'gold',	stats:{	'power':802,	'defense':792,	'speed':10	},	costType:'FIXED',	baseCosts:[{	id:'antimatter',	count:170500	}],	notifs:['interstellarMovitonPane'],	atmosphere:true,	subStatus:'none',	probeBaseCosts:[{	id:'probe',	count:1	},	{	id:'antimatter',	count:170500	}],	terraformBaseCosts:[{	id:'terraformer',	count:1	},	{	id:'antimatter',	count:170500	}],	statueBaseCosts:[{	id:'gold',	count:100000000000000	},	{	id:'gold',	count:100000000000000	}],	}
